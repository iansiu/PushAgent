  ...
  <script>
    const I18N = {
      en: {
        ...
        pairedDeviceMissing: "The QiuyuRemote device for this pairing code is no longer registered. Generate a new code on the device and try again.",
      ...
      zh: {
        ...
        pairedDeviceMissing: "这个配对码对应的 QiuyuRemote 设备记录已不存在。请在该设备上重新生成配对码后再试。",
    ...
    function localizedAgentMessage(value) {
      ...
      const exact = {
        ...
        "QiuyuRemote device for this pairing code is no longer registered.": "pairedDeviceMissing",
